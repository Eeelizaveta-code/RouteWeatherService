## О чем проект
Это сайт для путешественников на Flask, показывающий погоду в двух точках: точке отбытия и точке пребытия – использующий OpenWeather API. Также построены интерактивные графикиPlotly.
